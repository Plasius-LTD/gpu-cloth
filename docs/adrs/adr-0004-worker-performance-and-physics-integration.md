...
Introducing cloth should not invent another scheduler or control loop.

## Decision

`@plasius/gpu-cloth` will:
...
- Cloth joins the established GPU pipeline instead of fragmenting it.
