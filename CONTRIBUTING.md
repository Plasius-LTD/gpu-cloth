# Contributing to @plasius/gpu-cloth
...
`@plasius/gpu-cloth` provides cloth-planning and integration contracts for the
Plasius GPU stack:

- continuity-aware near, mid, far, and horizon cloth representations
- stable physics snapshot handoff for derived cloth state
...
- Cloth continuity and physics/visual separation are architectural
